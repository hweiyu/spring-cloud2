...
import com.imin.infrastructure.common.dto.IdStringDto;
...
public class DemoController extends BaseController {
    ...
    @ApiOperation(value = "根据key删除缓存", notes = "根据key删除缓存")
    @PostMapping(value = "/demo/deleteByCacheKey", produces = MediaType.APPLICATION_JSON_VALUE)
    @RequestProcess(checkLogin = false)
    public ResultData<Void> deleteByCacheKey(@RequestBody IdStringDto idDto) {
        redisService.delKey(idDto.getId());
        return ResultData.createSuccessResult(null);
    }

    @ApiOperation(value = "根据key查询数据", notes = "根据key查询数据")
    @PostMapping(value = "/demo/getByCacheKey", produces = MediaType.APPLICATION_JSON_VALUE)
    @RequestProcess(checkLogin = false)
    public ResultData<String> getByCacheKey(@RequestBody IdStringDto idDto) {
        return ResultData.createSuccessResult(redisService.get(idDto.getId()));
    }

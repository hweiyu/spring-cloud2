package com.imin.basic.conf.web;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.imin.basic.controller", useDefaultFilters = false, includeFilters = {
...
public class WebAppConfig extends WebMvcConfigurerAdapter {
	...
	public LocalValidatorFactoryBean localValidatorFactoryBean() {
		...
		localValidatorFactoryBean
				.setValidationMessageSource(resourceBundleMessageSource());
		return localValidatorFactoryBean;
	}

...
import com.imin.user.dto.request.QueryDemoReqDto;
import com.imin.user.dto.response.DemoDto;
import com.imin.user.feign.basic.DictApiServiceRemote;
import com.imin.user.service.DemoService;
...
public class DemoController extends BaseController {
    ...
    @PostMapping(value = "/demo/test", produces = MediaType.APPLICATION_JSON_VALUE)
    @RequestProcess(checkLogin = false, logUrl = "/demo/test", popedomCode = "demo",
            popedomType = PopedomType.Delete, saveResult = true)
    public ResultData<List<DictResDto>> test(@RequestBody DictListReqDto reqDto) {
        return dictApiServiceRemote.list(reqDto);
    }
